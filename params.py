...
# This contains the basic params needed to run the pipeline. Please see config.py to see more details of how to change the pipeline.
...
PARAMS = {
    "pipeline_config": {
        ...
        "elective_admissions_dataset" : "", # Name of dataset to read elective admissions
        "emergency_admissions_dataset" : "", # Name of dataset to read emergency admissions
        "patients_input_dataset" : "", # Name of dataset containing patients input data, such as names
    },
}
